# Semantica_Consignacao

Projeto aplicação de análise semantica no processo de consignação do app MeuGov.


LINKS: 
 
Tutorial SERPRO LLM em notebook jupyter: https://git.serpro/81817002368/tutorial-serpro-llm

https://llm.ia.serpro.gov.br/playground/
Playground
 
Get your documents ready for gen AI: docling 
 
https://github.com/docling-project/docling

Autorizações PLIN 
https://plin.estaleiro.serpro.gov.br/#/pages/home
